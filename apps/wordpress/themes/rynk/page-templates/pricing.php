...
<div class="relative text-brand-text overflow-x-hidden">
	...
	<section class="relative px-6 py-5 md:px-10 md:py-5">
		...
		<div class="relative mx-auto max-w-3xl text-center">
			...
			>
				Pick the tier that fits your business. Not sure yet? <a href="<?php echo esc_url( home_url( '/how-it-works/' ) ); ?>" class="text-brand-blueSoft underline underline-offset-2 hover:text-brand-text transition-colors">See how Rynk works</a> before you choose.
			</p>
		</div>
	</section>
