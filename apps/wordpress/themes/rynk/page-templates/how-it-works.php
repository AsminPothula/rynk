		...
		<div class="relative mx-auto max-w-screen-xl">
			<div class="mb-8">
				...
				<p class="mt-5 text-[15px] leading-[1.75] text-brand-textMute">
					More customers reaching out to you - here&rsquo;s what Rynk delivers. Ready to get started? <a href="<?php echo esc_url( home_url( '/pricing/' ) ); ?>" class="text-brand-blueSoft underline underline-offset-2 hover:text-brand-text transition-colors">See Rynk pricing plans</a>.
				</p>
			</div>
